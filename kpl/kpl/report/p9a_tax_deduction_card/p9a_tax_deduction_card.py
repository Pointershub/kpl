...
def get_columns():
    columns = [{
        ...
        },
        {
            ...
            "label": _("Defined Contribution Retirement Scheme | E1 (30%)"),
            "fieldtype": "Currency",
            "width": 150
        },
        {
            "fieldname": "e2_defined_contribution_retirement_scheme",
            "label": _("Defined Contribution Retirement Scheme | E2 (Actual)"),
            "fieldtype": "Currency",
            "width": 150
        },
        {
            "fieldname": "e3_defined_contribution_retirement_scheme",
            "label": _("Defined Contribution Retirement Scheme | E3 (Fixed)"),
            "fieldtype": "Currency",
            "width": 150
        },
        {
...
def get_p9a_tax_deduction_card_amt(filters, employee, month_start_date, month_end_date, p9a_tax_deduction_card_type,
                                   currency, company_currency):
    currency_filter = ''
...
def get_p9a_tax_deduction_card_gross_pay(filters, employee, month_start_date, month_end_date, currency,
                                         company_currency):
    currency_filter = ''
    if filters.get("currency") and filters.get("currency") != company_currency:
        currency_filter = currency
